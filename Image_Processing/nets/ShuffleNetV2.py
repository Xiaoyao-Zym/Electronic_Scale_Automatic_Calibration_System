...
# #整体网络
# class shufflenet(nn.Module):
#     def __init__(self,num_class, size, in_channel, out_channel):
#         """size表示模型大小"""
#         super(shufflenet, self).__init__()
#         self.num_class=num_class
#         #self.inchannel=24
...
#         self.initial=nn.Sequential(nn.Conv2d(kernel_size=1, padding=0, in_channels=in_channel, out_channels=out_channel, stride=1),
