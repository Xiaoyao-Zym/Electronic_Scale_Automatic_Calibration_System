        ...
        if dir_test_path =='':
            ...
            with open(dir_test_path, "r") as f:
                ...
                for image_line in f.readlines():
                    ...
                    if not os.path.exists(dir_save_path):
                            os.makedirs(dir_save_path)
                    r_image.save(os.path.join(dir_save_path, image_name), quality=95, subsampling=0)
