...
def parse_opt():
    ...
    parser.add_argument('--model_type', type=str, default='DRNet_V8', help='模型改进轮数')
    ...
    parser.add_argument('--nclass', type=int, default=11)
    ...
    parser.add_argument('--best', type=float, default=0.95, help='如果不保存所有模型，他就之会保存最好的和最后的模型，最好的模型准确率必须高于best才会保存')
