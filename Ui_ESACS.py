...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Controller_Experiment_20kg = QtWidgets.QPushButton(self.centralwidget)
        self.Controller_Experiment_20kg.setEnabled(True)
        self.Controller_Experiment_20kg.setGeometry(QtCore.QRect(1190, 20, 161, 50))
        font = QtGui.QFont()
        font.setFamily("Adobe 宋体 Std L")
        font.setPointSize(14)
        self.Controller_Experiment_20kg.setFont(font)
        self.Controller_Experiment_20kg.setObjectName("Controller_Experiment_20kg")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Controller_Experiment_20kg.setText(_translate("MainWindow", "30Kg检定"))
